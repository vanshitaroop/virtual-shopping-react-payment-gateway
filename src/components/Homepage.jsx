...
const Homepage = () => {
    return (
      ...
      <section class="why_section layout_padding">
        ...
        {/* SVG paths and other elements */}
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        Fast Delivery Get Your Orders in No Time
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        We are delighted to offer free shipping on all orders!
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        Experience the best quality products when you shop with us</p>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <section class="" style={{height:"460px",backgroundColor:"#D4CED0"}}>
         <div class="container">
            <div class=" row" style={{height:"50px"}}>
               <div class="arrival_bg_box col-md-6">
                  <img src={arrival} alt=""/>
               </div>
               <div class="col-md-6 ">
                     <div class="heading_container remove_line_bt" style={{marginTop:"50px"}}>
                        <h2>
                          Our Aim
                        </h2>
                     </div>
                     <p style={{marginTop:"20px",marginBottom:"30px"}}>
                        We are trying to introduce virtual trial, with the help of masking 
                        <hr/></p>
                   <p>
                   At our clothing brand, we are dedicated to providing you with high-quality clothing and an innovative trial program that allows you to shop with confidence. We strive to exceed your expectations, deliver exceptional customer service, and create a memorable shopping experience. Join us on this fashion journey and discover your unique style with our trial program.
                   </p>
                  </div>
            </div>
         </div>
               ...
               <div class="row">
                  <div class="col-md-6 offset-md-3">
                     <div class="subscribe_form ">
                        ...
                        <p>Join our community of fashion enthusiasts and enjoy the benefits of being a valued subscriber.</p>
